...
<head>
    ...
    <script>
        var ref = angular.module("doctormodule", []);
        ref.controller("doctorcontroller", function($scope, $http) {
            $scope.jsonArray = []; //empty json array
            $scope.jsonCity = [];
            $scope.city = "none";
            $http.get("fetchcities_doctor.php").then(okcity, notokcity);
            ...
            function loadDoctor() {
                ...
                $http.get("fetch_alldoctors.php?city="+$scope.city).then(okFn, notOkFn);
...
<body ng-app="doctormodule" ng-controller="doctorcontroller">
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <span style="margin-left:400px;font-size:40px;color:darkolivegreen;" class="weight">  Veterinarians</span>
    ...
    <div class="container">
       <div class="row offset-3 mt-4">
        ...
        <div class="form-group col-md-2">
            <label for="city"><b class="weight">Choose City</b></label>
        ...
        <div class="form-group col-md-3" style="margin-top:35px" >
            <button class="btn btn-primary" ng-click="getDoctor();">Show Results</button>
        </div>
    </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table bg-light" width="100%"  style="border-radius:10px 10px 10px 10px;border:2px black solid;">
                        <tr>
                        ...
                        <tr  align="center">
                            <td><b class="weight">Qualification</b></td>
                            <td>{{temp.qualification}} </td>
                        </tr>
                        <tr align="center">
                            <td><b class="weight">Experience</b></td>
                            <td>{{temp.exp}} </td>
                        </tr>
                        <tr align="center">
